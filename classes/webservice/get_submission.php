...
class get_submission extends external_api {
    ...
    public static function service_returns() {
        return new \external_single_structure([
                'response' => new \external_single_structure(
                        definition_helper::define_for_webservice(submission_model::class)
                )
        ]);
    }
    ...
    public static function service(array $request) {
        ...
        $result =  ['response' => get_submission_service::instance()->set_submissionid($args->request['submissionid'])->get_data()];
        return $result;
    }
}
